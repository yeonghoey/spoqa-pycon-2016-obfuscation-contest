...
def ___(______, _______, ________): _____ = list(map(lambda _: _[1], list(map(lambda _: (globals()['__'](), eval(str(______)+_+str(eval(_______)))), list(filter(lambda __: __ == globals()['_'](), ________)))))); return ___(sum(_____), _______, ________) if _____ else ______
